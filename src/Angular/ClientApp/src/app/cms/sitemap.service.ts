...
import { CoolAppsComponent } from './cool-apps/cool-apps.component';
...
export class SitemapService {
  ...
  private onSuccessfulGetSiteMap(result): void {
    ...
    for (let route of result) {
      ...
      } else if (route.PageTypeName === "Cool apps page") {
        siteRoutes.push({ path: link, component: CoolAppsComponent });
      }
